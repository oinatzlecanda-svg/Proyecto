...
- Generado con Higgsfield: storyboard `gpt_image_2` + realismo `seedream_v5_pro`, vídeo y música
  `seedance_2_5` (omni-reference, audio nativo). Textos añadidos con ffmpeg.

## Estética

Editorial joven europea, ligeramente premium. Arquitectura de piedra caliza beige, soportales y
columnas, calle limpia, luz cálida de final de tarde de otoño con sombras largas. Paleta crema,
marrón, gris piedra, negro y kaki. Acabado fotográfico con grano ligero.

Prendas (fotos de referencia de la marca): botas altas de ante greige con herraje dorado
(protagonistas), chaqueta de flecos camel, chaqueta cropped de flecos marrón, jersey de punto
taupe, jersey negro de pico y jeans Lucía de pierna ancha.

## Cortes (detectados en el vídeo final)

| Tiempo | Plano |
|---|---|
| 0–1,8 s | Botas caminando, plano bajo en travelling |
| 1,8–3,8 s | Chaqueta de flecos camel en movimiento |
| 3,8–5,0 s | Chaqueta marrón de espaldas, mirada por encima del hombro |
| 5,0–6,4 s | Jersey de punto taupe + denim, apoyada en la pared de piedra |
| 6,4–8,0 s | Jersey negro + denim caminando por los soportales |
